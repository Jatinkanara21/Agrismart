...
class FarmPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final farm = context.watch<AgriProvider>().farm;
    return SafeArea(
      child: ListView(
  ...
  Widget build(BuildContext context) {
    ...
    switch (title) {
      case 'Crop Recommendation':
        body = const CropRecommendationView();
        break;
      case 'Disease Detection':
        body = const DiseaseView();
        break;
      case 'Yield Prediction':
        body = const YieldView();
        break;
      case 'AgriBot':
        body = const BotView();
        break;
      case 'Decision Engine':
        body = const DecisionView();
        break;
      case 'Soil Health':
        body = const SoilView();
        break;
      case 'Smart Irrigation':
        body = const IrrigationView();
        break;
      case 'Fertilizer Recommendation':
        body = const FertilizerView();
        break;
      default:
        body = GenericView(title: title);
    }
...
class DecisionView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final insights = context.watch<AgriProvider>().insights;
    return ListView(
      padding: const EdgeInsets.all(18),
